...
This directory has one canonical current auth design note, one active roadmap, and one
short open-question note:
...
update `AUTH_ROADMAP.md`. If a decision is still open, update `AUTH_OPEN_QUESTIONS.md`.
