...
#[tokio::test]
async fn kv_item_basic_lifecycle_type_round_trips_and_raw_bytes_match_stable_invariants() {
...
#[tokio::test]
async fn kv_item_literal_prefix_matching_and_max_key_length_match_stable_invariants() {
    let test_database = TestDatabase::connect().await;
